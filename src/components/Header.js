    ...
    return (
      <div>
        ...
        <p className='para'>
          ...
          respectively).<br />  Every cell interacts with its eight neighbours, which
          ...
          underpopulation.<br /> Any live cell with two or three live neighbours lives
          ...
          becomes a live cell. <br />All other live cells die in the next generation.
          ...
          which this happens is sometimes called a tick. <br />Each generation is a
